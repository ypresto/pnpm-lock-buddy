...
Supports lockfiles generated by pnpm v9 through v12, including the
multi-document `pnpm-lock.yaml` format (env document + project document)
introduced in pnpm v11.25.0/v12.0.0 for config dependencies or a pinned pnpm
version. See [pnpm's lockfile format docs](https://pnpm.io/lockfile) for
details.
